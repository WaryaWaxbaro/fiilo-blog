  ...
  def create
    ...
    respond_to do |format|
      if @blog_element.save
        ...
        format.html { redirect_to edit_authors_post_path(@blog_element.post_id), notice: "Blog element was successfully created." }
  ...
  def update
    respond_to do |format|
      if @blog_element.update(blog_element_params)
        ...
        format.html { redirect_to edit_authors_post_path(@blog_element.post_id), notice: "Blog element was successfully updated." }
