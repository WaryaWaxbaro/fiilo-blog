// javascript/controllers/admin_contact_controller.js
...
export default class extends Controller {
    static targets = ["mainContainer", "contactsTableContainer", "query", "perPage"];
    ...
    updateDataOnInitialLoad(){
        ...
        if(this.contactsTableContainerTarget){
            currentPage = this.contactsTableContainerTarget.dataset.currentPage;
        }
